...
var PDFiumModule = (() => {
  ...
  return async function (moduleArg = {}) {
    ...
    var ENVIRONMENT_IS_SHELL = !ENVIRONMENT_IS_WEB && !false && !ENVIRONMENT_IS_WORKER;
...
const CDN_WASM_LINK = `https://cdn.jsdelivr.net/npm/@hyzyla/pdfium@${"2.1.7"}/dist/pdfium.wasm`;
const WASM_INTEGRITY = `sha256-${"YX7CMSGUekQH5gZJ5uCk7gC8ImOjROI6cMLpJHIV5wE="}` ;
...
class PDFiumLibrary extends PDFiumLibrary$1 {
    static init(options) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!(options === null || options === void 0 ? void 0 : options.disableCDNWarning)) {
            ...
            const response = yield fetch(CDN_WASM_LINK, fetchOptions);
...
PDFiumLibrary._cache = null;

export { FPDFMetadataTag, FPDFPathSegmentType, FPDFProgressiveStatus, FPDF_OCG_INTENT_ALL, FPDF_OCG_INTENT_DESIGN, FPDF_OCG_INTENT_VIEW, FPDF_OCG_STATE_OFF, FPDF_OCG_STATE_ON, FPDF_OCG_STATE_UNCHANGED, FPDF_OCG_USAGE_DESIGN, FPDF_OCG_USAGE_EXPORT, FPDF_OCG_USAGE_PRINT, FPDF_OCG_USAGE_VIEW, OCGContext, OCGManager, PDFiumDocument, PDFiumFormObject, PDFiumImageObject, PDFiumLibrary, PDFiumModule, PDFiumPage, PDFiumPathObject, PDFiumProgressiveRenderer, PDFiumShadingObject, PDFiumTextObject, getOCGStateName, getOCGUsageName };
